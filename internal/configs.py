...
class Config:
  ...
  eval_save_colour_depth: bool = True
  ...
  # Gradient Scaling
  gradient_scaling: bool = False  # From https://arxiv.org/abs/2305.02756


  # SurfNeRF (Naylor et al. 2024)
  surface_reg: bool = False
  surface_reg_sched_init: int = 4096 # Regularise on a curriculum learning schedule with this initial frequency (first 6% of training)
  surface_reg_sched_final: int = 16 # End with this frequency (around last 6% of training)
  surface_samples: int = 64 # Number of directional and spatial samples
  surface_spatial_loss_mult: float = 1e-2
  surface_normal_loss_mult: float = 1e-2
  surface_tv_loss_mult: float = 1e-1
  surface_bias_loss_mult: float = 1e-5
  surface_sphere_type: str = "vmf" # Can be any of random, vmf, or fib
  surface_vol_samples: bool = True # Sample the volume of the sampling sphere
  surface_visible_dirs: bool = True # During direction sampling, only consider rays which enter the surface (back face is unregularised!)

  # Permutohedral iNGP grid:
  hash_grid_type: str = "voxel" # Can be any of voxel or permuto

  # NeRF-Casting
  bilevel_normal_loss: bool = False
